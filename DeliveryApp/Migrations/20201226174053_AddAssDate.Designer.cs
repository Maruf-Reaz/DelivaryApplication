...
namespace DeliveryApp.Migrations
{
    ...
    [Migration("20201226174053_AddAssDate")]
    partial class AddAssDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliveryApp.Models.Common.Authentication.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("DeliveryApp.Models.Common.Authentication.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DeliveryApp.Models.Common.Authentication.UserType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DeliveryApp.Models.DeliveryMan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DeliveryApp.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DeliveryApp.Models.Merchant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DeliveryApp.Models.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DeliveryApp.Models.PackageCatagory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("PackageCatagoies");
                });

            modelBuilder.Entity("DeliveryApp.Models.PickUpRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DeliveryApp.Models.Tarrif", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DeliveryApp.Models.Common.Authentication.ApplicationUser", b =>
                {
                    b.HasOne("DeliveryApp.Models.Common.Authentication.UserType", "UserType")
            ...
            modelBuilder.Entity("DeliveryApp.Models.Merchant", b =>
                {
                    b.HasOne("DeliveryApp.Models.Common.Authentication.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DeliveryApp.Models.Package", b =>
                {
                    b.HasOne("DeliveryApp.Models.DeliveryMan", "DeliveryMan")
                        .WithMany()
                        .HasForeignKey("DeliveryManId");

                    b.HasOne("DeliveryApp.Models.Location", "LocationTo")
                        .WithMany()
                        .HasForeignKey("LocationToId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DeliveryApp.Models.PackageCatagory", "PackageCatagory")
                        .WithMany()
                        .HasForeignKey("PackageCatagoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DeliveryApp.Models.PickUpRequest", "PickUpRequest")
                        .WithMany("Packages")
            ...
            modelBuilder.Entity("DeliveryApp.Models.PickUpRequest", b =>
                {
                    b.HasOne("DeliveryApp.Models.Location", "LocationFrom")
                        .WithMany()
                        .HasForeignKey("LocationFromId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DeliveryApp.Models.Merchant", "Merchant")
                        .WithMany()
                        .HasForeignKey("MerchantId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DeliveryApp.Models.DeliveryMan", "PickUpDeliveryMan")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("DeliveryApp.Models.Common.Authentication.ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DeliveryApp.Models.Common.Authentication.ApplicationUser")
                        .WithMany()
