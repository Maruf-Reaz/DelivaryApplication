    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageCatagoies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Tarrifs_PackageCatagoies_PackageCatagoryId",
                        column: x => x.PackageCatagoryId,
                        principalTable: "PackageCatagoies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Packages_PackageCatagoies_PackageCatagoryId",
                        column: x => x.PackageCatagoryId,
                        principalTable: "PackageCatagoies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "d925b59b-7456-1442-d0n0-bdec765e3awv", "ea9a3b0f-9b5f-7153-81e0-4fd799e23f17", new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Has Minimum Permissions", "Merchant", "MERCHANT" },
                    { "d925b59b-7456-1442-d0n0-bdec765e3awx", "ea9a3b0f-9b5f-7153-81e0-4fd799e23f18", new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Has Minimum Permissions", "DeliveryMan", "DELIVERYMAN" }
                });
